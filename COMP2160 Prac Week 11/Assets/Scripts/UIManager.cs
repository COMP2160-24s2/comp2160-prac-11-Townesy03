...
#region Update
    ...
    {
        Vector2 mousePosScreen = mouseAction.ReadValue<Vector2>();
        Vector3 mousePos = Camera.main.ScreenToWorldPoint(new Vector3(mousePosScreen.x, mousePosScreen.y, 9.8f));
